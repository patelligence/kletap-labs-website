...
// Ambient blue/cyan gradient orbs that drift slowly behind all content.
export function AnimatedBackground() {
  return (
    ...
    >
      ...
      />
      <motion.div
        className="absolute -bottom-32 left-1/3 h-[500px] w-[500px] rounded-full bg-violet/10 blur-[140px]"
