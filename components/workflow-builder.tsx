...
const workflowLibrary: Record<string, Workflow> = {
  "Gym|Missed calls": {
    ...
    aiAction:
      "Patelligence texts the caller within 10s, qualifies their interest, offers a free trial pass, and books a tour automatically.",
  ...
  "Veterinary Clinic|Scheduling": {
    ...
    aiAction:
      "Patelligence checks availability, asks the visit reason, books the slot, and sends pre-visit instructions.",
  ...
  "Veterinary Clinic|Intake forms": {
    ...
    aiAction:
      "Patelligence texts a personalized digital intake link, parses the responses, and pre-populates the patient record.",
  ...
  "Liquor Store|Customer FAQs": {
    ...
    aiAction:
      "Patelligence answers using your live inventory + policies, suggests pairings, and routes complex orders to staff.",
  ...
  "Liquor Store|Review requests": {
    ...
    aiAction:
      "Patelligence sends a thank-you SMS 2 hours later with a one-tap review link, and escalates negative sentiment privately.",
  ...
  "Contractor|Lead follow-up": {
    ...
    aiAction:
      "Patelligence sends contextual follow-ups (objection handling, financing options) and books a call when the lead engages.",
  ...
  "Contractor|Missed calls": {
    ...
    aiAction:
      "Patelligence texts the caller, captures job type/address/timeline, and drops a structured lead into your CRM.",
  ...
  "Real Estate Agent|Lead follow-up": {
    ...
    aiAction:
      "Patelligence sends a multi-channel nurture with tailored listings and market updates until the lead re-engages.",
  ...
  "Real Estate Agent|Scheduling": {
    ...
    aiAction:
      "Patelligence checks your calendar + listing access, proposes 3 times, locks the appointment, and sends reminders.",
  ...
  "Gym|Lead follow-up": {
    ...
    aiAction:
      "Patelligence sends a personalized 5-touch sequence over 10 days — tailored to their stated goals.",
...
function genericWorkflow(business: BusinessType, pain: PainPoint): Workflow {
  return {
    ...
    trigger: `An event tied to "${pain.toLowerCase()}" occurs in your business.`,
    aiAction:
      "Patelligence detects the event, runs a tailored playbook, sends the right message to the right person at the right time, and logs the outcome.",
...
// Interactive AI Workflow Builder — pick a business + pain, get a tailored automation.
export function WorkflowBuilder() {
  ...
  function generate() {
    ...
    setTimeout(() => {
      ...
      setWorkflow(workflowLibrary[key] ?? genericWorkflow(business, pain));
      setGenerating(false);
    }, 700);
  }
      ...
      <div className="container">
        <SectionHeading
          ...
          title={
            <>
              See your{" "}
              <span className="gradient-text">first AI workflow in 30 seconds.</span>
            </>
          }
          subtitle="Pick a business type and a pain point. We'll show you exactly what Patelligence would automate."
        />
              ...
              {!workflow && !generating && (
                ...
                >
                  ...
                  <p className="mt-2 max-w-sm text-sm text-muted">
                    Configure on the left, then click{" "}
